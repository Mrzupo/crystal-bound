...
local function getCanonicalTrader()
	...
	if not folder or not trader or not trader:IsA("Model") or trader.Parent ~= folder then return nil end
	if trader.Name ~= "MaterialTrader" or trader:GetAttribute("Interactable") ~= true then return nil end
	return trader
end
