...
local function rewardDefeat(player, profile, targetModel, action, crystalId)
	...
	if earnedMoney < moneyGain then
		player:SetAttribute("LootMessage", string.format("Enemy defeated! +%d Money (wallet cap)", earnedMoney))
	end
