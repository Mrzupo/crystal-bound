...
if starter then
	local ready = starter:FindFirstChild("StarterDecorReady") and hasCount(starter, "TreeTrunk", 4) and hasCount(starter, "TreeCanopy", 4) and hasCount(starter, "Rock", 3) and starter:FindFirstChild("TrainingCamp") and starter.TrainingCamp:GetAttribute("CrystalBoundDecor") == true
	if not ready then
