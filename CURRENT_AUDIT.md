...
- The Studio playtest plan now includes superseded-profile-load and shutdown/leave race cases so per-load session-token isolation can be verified under real runtime conditions.
